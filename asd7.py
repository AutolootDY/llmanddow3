...
st.subheader("Data Preview: NASDAQ Data")
...
if portfolio_summary:
    ...
    for i, entry_date in enumerate(rebal_dates):
        ...
        dji_period_returns.append({
            ...
            'exit_date': exit_date, 
            'NASDAQ_period_return': dji_return,
    ...
    final_dji_return = performance_df['NASDAQ_cum_return'].iloc[-1]
    st.write(f"**ผลตอบแทนสะสมของ NASDAQ:** {final_dji_return:.2%}")
